...
IGameModel*		m_pModel1;


IGameModel*		m_pModel2;
...
INT Init()
{
	LpDev_TextureInit(m_pd3dDevice);


	if(FAILED(LpDev_ModelCreate(IGameTexture::FILE, &m_pModel1, m_pd3dSprite, "Texture/earth.txt")))
		return -1;


	if(FAILED(LpDev_ModelCreate(IGameTexture::FILE, &m_pModel2, m_pd3dSprite, "Texture/animate.txt")))
		return -1;
...
INT FrameMove()
{
	...
	m_pModel2->SetPos((FLOAT*)&m_vcPosImg2);
	m_pModel2->FrameMove();
