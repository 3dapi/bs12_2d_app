...
public:
	...
	virtual int		Create(void* ModelName);
...
LPD3DXSPRITE CGameModel2D::m_pSprite = NULL;

void LpDev_ModelInit(void* pSprite)
{
	CGameModel2D::m_pSprite = (LPD3DXSPRITE)pSprite;
}
...
int CGameModel2D::Create(void* ModelName)
{
...
int LpDev_ModelCreate(int nOpt, IGameModel** pData, void* pModelName)
{
	*pData = NULL;
