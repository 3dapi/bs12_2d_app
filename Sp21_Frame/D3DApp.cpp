...
INT CD3DApp::Create( HINSTANCE hInst)
{
	...
	dInterval[0] = D3DPRESENT_INTERVAL_IMMEDIATE;
	dInterval[1] = D3DPRESENT_INTERVAL_FOUR;
	dInterval[2] = D3DPRESENT_INTERVAL_THREE;
	dInterval[3] = D3DPRESENT_INTERVAL_TWO;
	dInterval[4] = D3DPRESENT_INTERVAL_ONE;
	dInterval[5] = D3DPRESENT_INTERVAL_DEFAULT;
	...
	for(i=0; i<6; ++i)
	{
		m_iPresentationInterval= dInterval[i];
		m_d3dpp.PresentationInterval= m_iPresentationInterval;
...
INT CD3DApp::Reset3D()
{
	...
	m_d3dpp.PresentationInterval = m_bWindow? m_iPresentationInterval : D3DPRESENT_INTERVAL_DEFAULT;
